// UnifiedMemory API Client
// Uses same-origin relative paths when NEXT_PUBLIC_MCP_URL is unset (Docker mode)
// Falls back to Cloudflare Worker for external deployments
const MCP_URL = process.env.NEXT_PUBLIC_MCP_URL || "";
const API_BASE = MCP_URL || "";
